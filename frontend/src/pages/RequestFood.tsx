...
import { Heart, ArrowLeft, MapPin, Phone, Mail, Package, Building2, Calendar } from "lucide-react";
import { useToast } from "@/hooks/use-toast";
import { z } from "zod";
import { foodRequestApi, helperOrgApi } from "@/services/api";
...
const RequestFood = () => {
  ...
  // Optional: preload orgs for quick selection (not required)
  // We won't force selection
  // fetch minimal list once the component mounts lazily on demand when user clicks dropdown
